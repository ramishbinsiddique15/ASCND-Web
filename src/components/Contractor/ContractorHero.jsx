    ...
    return (
        ...
        >
            <div className="mx-auto max-w-[100rem] px-4 md:px-8">
                {/* Content grid */}
        <motion.div
            className="grid grid-cols-1 items-stretch gap-8 pb-8 pt-10 md:grid-cols-12 md:gap-20 md:pb-10 md:pt-14 md:min-h-[380px] lg:min-h-[460px] lg:gap-28 lg:pt-16"
                    variants={container}
                >
                    {/* Left: Tag + Headline */}
            <motion.div className="md:col-span-7 min-w-0 flex h-full flex-col justify-end md:pr-6 lg:pr-10" variants={container}>
                ...
                <motion.span variants={fadeUp} className="block md:whitespace-normal xl:whitespace-nowrap">Company.</motion.span>
                    ...
                    {/* Right: Copy */}
            <motion.div className="md:col-span-5 min-w-0 flex h-full flex-col justify-end md:pl-8 lg:pl-12" variants={container}>
