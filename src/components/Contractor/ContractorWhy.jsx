...
const WhyItem = ({ image, clip = CLIP_DIAG, headingTop, headingBottom, gradientWord, body, pills }) => (
  ...
  <motion.div className="md:col-span-5" variants={imgVar}>
      <div className="relative h-56 overflow-hidden rounded-2xl md:h-[360px] lg:h-[460px]">
        <img
          src={image}
          alt=""
    ...
    {/* Text */}
    <motion.div className="w-[75%] md:col-span-7 h-full md:pl-6 lg:pl-10 flex flex-col justify-end pb-8" variants={textVar}>
      ...
      >
        Apply Now
        <img src={doubleArrowWhite} alt="" className="h-3 w-3" />
      </motion.button>
    </motion.div>
  </motion.div>
);
...
const ContractorWhy = () => {
  ...
  <div className="flex flex-col gap-16 py-6 md:gap-20 md:py-10">
          <WhyItem
            image={power}
            headingTop=""
