    ...
    return (
        ...
        >
            ...
            <div className="absolute top-20 sm:top-32 md:top-44 -right-48 sm:-right-64 md:-right-80 lg:-right-96">
                <img src={polymer} alt="Geometric shapes" className="w-[80%] sm:w-[70%] md:w-[60%] max-w-none" />
            </div>
            ...
            <div className="relative z-10 px-4 py-8 sm:px-6 sm:py-12  md:py-16  max-w-7xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-0">
                    <motion.div variants={itemVariants} className="space-y-3 sm:space-y-4 w-full lg:w-auto">
                        ...
                        >
                            <p className="text-[#FF990A] text-sm sm:text-base font-medium">The first ASCND dealer in a state secures an override (or per-unit in non-solar trades)</p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="border-2 border-[#FF990A] rounded-full px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 w-fit"
                        >
                            <p className="text-[#FF990A] text-sm sm:text-base font-medium">Maintain control while we handle fulfillment</p>
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="border-2 border-[#FF990A] rounded-full px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 w-fit"
                        >
                            <p className="text-[#FF990A] text-sm sm:text-base font-medium">Works across all ASCND trades</p>
                        </motion.div>
                    </motion.div>
