...
<div className="absolute inset-0 bg-gradient-to-b from-[#105CE9]/50 to-[#105CE9]" />
      ...
      <div className="relative z-10 px-8 py-16 max-w-7xl mx-auto">
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <h1 className="text-white text-7xl font-extrabold leading-tight">Summit Program</h1>
        </motion.div>

        <motion.div variants={itemVariants} className="w-full h-0.5 bg-white mb-12"></motion.div>
        ...
        <div className="flex justify-between items-start">
          <motion.div variants={itemVariants} className="space-y-4">
            <motion.div 
              ...
              className="border-2 border-white rounded-full px-6 py-3 w-fit"
            >
              <p className="text-white text-base font-medium">Keep 100% of your commission + % of install margin</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="border-2 border-white rounded-full px-6 py-3 w-fit"
            >
              <p className="text-white text-base font-medium ">Maintain control while we handle fulfillment</p>
            </motion.div>
            ...
            <motion.div 
              ...
              className="border-2 border-white rounded-full px-6 py-3 w-fit"
            >
              <p className="text-white text-base font-medium ">Works across all ASCND trades</p>
            </motion.div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col items-end space-y-6">
            ...
            {/* Apply Now button */}
            <motion.button 
              className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold text-sm tracking-wider hover:bg-gray-100 transition-colors duration-200 flex items-center gap-2"
