...
const Banner = () => {
  ...
  return (
    <section className="fixed inset-0 w-full overflow-hidden text-[#F6F6F4]">
      ...
      <motion.div
        className="absolute top-4 right-4 sm:right-6 lg:right-8 flex items-center gap-2 z-10"
      ...
      {/* Main Content Container - Uses flex to push content to bottom */}
      <div className="absolute inset-0 flex flex-col">
        ...
        <div className="flex-shrink-0 px-4 sm:px-6 lg:px-8 pb-4 sm:pb-6">
          {/* Logo and Heading Container with consistent spacing */}
          <motion.div
            ...
            animate="visible"
          >
            {/* Logo with consistent margin */}
            <motion.div className="mb-8 sm:mb-12 lg:mb-16" variants={logoAnimation}>
      ...
      tracking-[-0.04em]
          ...
          {/* Navigation Bar - Always at bottom with consistent spacing */}
          <motion.div
            className="relative"
            variants={bottomBar}
            initial="hidden"
          ...
          >
            ...
            <div className="hidden lg:flex items-center justify-between border-t pt-9 border-t-[#F6F6F4]">
              <motion.div
                className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#F6F6F4] to-transparent"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
