          ...
          <motion.div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2" variants={container}>
                  ...
                  <div className="self-end">
                    ...
                    <motion.div className="mt-4 sm:mt-5 flex w-full items-stretch gap-2 sm:gap-3" variants={fadeUp}>
                      <motion.input
                        ...
                        className="flex-1 min-w-0 rounded-md border-[2px]border-[#F6F6F4]/60 bg-[#FF4C1680]/50 px-3 py-2.5 text-[11px] sm:px-4 sm:py-3 font-semibold uppercase tracking-[0.25em] text-[#F6F6F4] placeholder-[#F6F6F4] outline-none focus:border-[#F6F6F4] transition-border-color duration-200 border-[1px] border-[#F6F6F4]"
                        variants={formField}
                      />
                      <motion.button
                        className="flex-shrink-0 whitespace-nowrap rounded-md bg-[#F6F6F4] px-4 py-2.5 text-[11px] sm:px-5 sm:py-3 font-semibold uppercase tracking-[0.25em] text-[#FF4C16] hover:bg-[#F6F6F4]/95 flex items-center justify-center gap-2 min-w-[140px] sm:min-w-[160px] cursor-pointer"
                        variants={formField}
                      >
                        Subscribe
            ...
            >
              ...
              <motion.form className="space-y-3" variants={container}>
                <motion.div className="grid grid-cols-1 gap-2 sm:grid-cols-2" variants={formField}>
                  <motion.input
                    type="text"
                    placeholder="FIRST NAME*"
                    className="placeholder-with-orange-asterisk rounded-lg border-[2px] border-[#4B5361] bg-[#F6F6F4] px-3 py-2.5 text-[11px] sm:px-4 sm:py-3 font-semibold tracking-[0.25em] text-[#0D1318] outline-none focus:border-[#FF4C16] transition-border-color duration-200"
                    variants={formField}
                  />
                  <motion.input
                    type="text"
                ...
                <motion.input
                  ...
                  className="placeholder-with-orange-asterisk w-full rounded-lg border-[2px] border-[#4B5361] bg-[#F6F6F4] px-3 py-2.5 text-[11px] sm:px-4 sm:py-3 font-semibold tracking-[0.25em] text-[#0D1318] outline-none focus:border-[#FF4C16] transition-border-color duration-200"
                  variants={formField}
                />
                ...
                <motion.div className="grid grid-cols-1 gap-3 sm:grid-cols-[1fr_auto] items-center" variants={formField}>
                  <motion.label
                    className="flex items-center gap-2 rounded-lg border-[2px] border-[#4B5361] bg-[#B0B8C740]/25 px-3 py-2.5 text-[11px] sm:px-4 sm:py-3 font-semibold text-[#4B5361] cursor-pointer h-full"
                  >
                  ...
                  <motion.button
                    type="button"
                    className="rounded-lg bg-[#0D1318] px-6 py-2.5 text-[11px] sm:px-8 sm:py-3 font-[700] uppercase tracking-[0.25em] text-[#F6F6F4] flex items-center justify-center gap-2 cursor-pointer h-full"
                    variants={formField}
                  >
                    Submit
