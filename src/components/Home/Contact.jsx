      ...
      <div className="mx-auto max-w-[100rem] px-4 sm:px-6   py-6 sm:py-8 md:py-12">
        <motion.div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-2" variants={container}>
          ...
          <motion.div className='self-end' variants={slideLeft}>
            <motion.img src={logo} alt="ASCND" className="h-5 sm:h-6 w-auto md:h-7 " variants={fadeUp} />
            ...
            <motion.div className="relative mt-3 overflow-visible h-82 rounded-2xl bg-[#FF4C16]" variants={fadeUp}>
              ...
              <div className="relative grid grid-cols-1 items-end gap-4 px-4 pb-4 pt-3 sm:px-5 sm:pb-5 sm:pt-4 md:px-6 md:pb-6 md:min-h-[260px] h-full z-50">
                <div className=" self-end">
                  ...
                  <motion.div className="mt-4 sm:mt-5 flex max-w-lg items-stretch gap-2 sm:gap-3" variants={fadeUp}>
                    ...
                    />
                    <motion.button className="whitespace-nowrap rounded-md bg-white px-4 py-2.5 text-[10px] sm:px-5 sm:py-3 sm:text-[11px] font-semibold uppercase tracking-[0.18em] text-[#FF4C16] shadow-sm hover:bg-white/95 flex items-center gap-2" variants={fadeUp}>
                      Subscribe
                  ...
                  {/* fine print */}
                  <motion.p className="mt-3 text-[10px] sm:text-[11px] leading-4 sm:leading-5 text-white/80" variants={fadeUp}>
              ...
              <div className="pointer-events-none absolute bottom-0 right-0 select-none hidden sm:block">
          ...
          {/* Right: Contact form */}
          <motion.article className="rounded-2xl border border-[#0D1318]/20 bg-[#FAFBFB] shadow-sm p-3 sm:p-4 md:p-6" variants={slideRight}>
            <motion.h4 className="text-[18px] sm:text-[20px] font-bold text-[#4B5361] mb-3 sm:mb-4" variants={fadeUp}>Contact Us</motion.h4>
            <motion.form className="space-y-3" variants={container}>
              <motion.div className="grid grid-cols-1 gap-3 sm:gap-4 sm:grid-cols-2" variants={fadeUp}>
                <motion.input
                  type="text"
              ...
              <motion.div className="grid grid-cols-1 gap-3 sm:grid-cols-[1fr_auto] items-center" variants={fadeUp}>
                <label className="flex items-center gap-2 rounded-lg border border-[#D9D9D9] bg-[#F3F4F6] px-3 py-2.5 text-[12px] sm:px-4 sm:py-3 sm:text-[13px] font-semibold tracking-[0.08em] text-[#0D1318]/80">
                  <input type="checkbox" className="accent-[#0D1318]" />
                  <span>Subscribe to news & updates</span>
                </label>
                <motion.button type="button" className="rounded-lg bg-[#0D1318] px-6 py-2.5 text-[12px] sm:px-8 sm:py-3 sm:text-[13px] font-semibold uppercase tracking-[0.18em] text-white flex items-center gap-2 hover:bg-[#0D1318]/90" variants={fadeUp}>
                  Submit
                  <img src={doubleArrowWhite} alt="" />
                </motion.button>
              </motion.div>

              <motion.div className="text-[11px] sm:text-[12px] leading-4 sm:leading-5 text-[#0D1318]/60 mt-2" variants={fadeUp}>
