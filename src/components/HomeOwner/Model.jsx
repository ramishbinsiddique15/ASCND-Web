...
const Model = () => {
  ...
  <div className="absolute inset-0 bg-[#FF4C16] mix-blend-multiply opacity-100" />
          ...
          <div className="relative px-4 py-8 sm:px-6 sm:py-10  md:py-12  lg:py-16 h-full z-10 flex flex-col justify-between">
            {/* Main heading */}
            <motion.h3 className="font-extrabold leading-[0.8] text-white text-[28px] sm:text-[36px] md:text-[44px] lg:text-[52px] xl:text-[56px] max-w-full sm:max-w-2xl" variants={fadeUp}>
              Why The ASCND<br />
              Model Works<br />
              for Homeowners
            </motion.h3>
            ...
            {/* Feature cards grid */}
            <motion.div className="mb-12 sm:mb-20 md:mb-40 lg:mb-96 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-6 sm:mt-8" variants={container}>
              {/* Build equity card */}
              <motion.div 
              ...
              >
                ...
                <span className="text-white text-sm sm:text-base md:text-lg font-semibold leading-[0.8]">Build equity with each upgrade</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-white text-sm sm:text-base md:text-lg font-semibold leading-[0.8]">Reduce monthly costs across utilities and maintenance</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-white text-sm sm:text-base md:text-lg font-semibold leading-[0.8]">Unlock financing options that make big improvements accessible</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-white text-sm sm:text-base md:text-lg font-semibold leading-[0.8]">Enjoy fast, high-quality installations by top-tier local pros</span>
              </motion.div>
            </motion.div>
          </div>
        </motion.div>
