...
tracking-[-0.04em]
        ...
        >
          <span className="block sm:inline">Build your business. Grow your</span>
          <br className="hidden sm:block" />
          <span className="block sm:inline">team. Become the installer</span>
          <br className="hidden sm:block" />
          <span className="text-[#FF4C16] block sm:inline">Ascnd is your partner every step</span>{" "}
          <br className="hidden sm:block" />
